...
/***/ (function(module, exports, __webpack_require__) {
	...
	var myAppId = config.APP_ID;
	var myKey = config.USER_KEY;

	var randyAjaxRequests = __webpack_require__(1);
	var randyResponseHandlers = __webpack_require__(2);
	var randyEventListeners = __webpack_require__(4);

	exports.myAppId = myAppId;
	exports.myKey = myKey;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _chatResponses = __webpack_require__(2);
	...
	var API = "https://aiaas.pandorabots.com";


	function postChat(words) {
	  $.ajax({
	    url: API + ("/talk/" + _index.myAppId + "/randy?user_key=" + _index.myKey + "&input=" + words),
	    method: "POST"
	  }).then(function (data) {
	    var botReply = data.responses;
	    (0, _chatResponses.addReplyText)(botReply);
	  }).fail(function () {
	    handleError();
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.addReplyText = addReplyText;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _chatRequests = __webpack_require__(1);
	...
	$(document).ready(function () {
	  ...
	  $("button").on("click", function (event) {
	    ...
	    (0, _chatResponses.appendInputText)(inputtedText);
	    sendChat(parsedText);
	  });
	});

	function sendChat(text) {
	  (0, _chatRequests.postChat)(text);
	}
